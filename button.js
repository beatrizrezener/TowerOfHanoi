goog.provide('towerofhanoi.Button');
 ...
 * @extends lime.Button
 */
towerofhanoi.Button = function(txt) {
    lime.GlossyButton.call(this, txt);

    this.borderWidth = 4;
    this.setColor('#9400D3');
};
goog.inherits(towerofhanoi.Button, lime.GlossyButton);

/**
 * @inheritDoc
 */
towerofhanoi.Button.prototype.makeState_ = function() {
 ...
 * @inheritDoc
 */
towerofhanoi.Button.prototype.setColor = function(clr) {
